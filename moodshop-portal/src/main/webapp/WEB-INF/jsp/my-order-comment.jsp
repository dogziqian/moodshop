													...
													<ul class="pro-info" oid="3122336930" pid="975788">
														<li class="fore1">
															<div class="p-info clearfix">
																<div class="p-img fl">
																	<a target="_blank"
																		href="http://item.jd.com/975788.html"> <img
																		width="50" height="50"
																...
																<div class="p-name fl">
																	<a target="_blank"
																		href="http://item.jd.com/975788.html">佳能（Canon）
																		MG2400 超值彩色喷墨一体机（打印 复印 扫描）</a>
																</div>
															</div>
														</li>
														<li class="fore2"><span class="ftx03">2014-10-25</span>
														</li>



														<li class="fore3 forem"><a href="#none"
															voucherstatus="0" class="pj" alt="975788" title="发评价拿京豆"
															catefirst="670" catesecond="716" catethird="720">发表评价<b
																class="icon-show"></b></a></li>
													</ul>
													<div class="clr"></div>
													<div class="comment-box prompt01" oid="3122336930"
														pid="975788" style="display: block;">
														<div class="box-t"></div>
														<div class="form" tagflag="true" isconspros="0"
															...
															<div class="item">
																...
																<div class="fl">
																	<span class="commstar"> <a href="javascript:;"
																		class="star1" _val="1"></a> <a href="javascript:;"
																		class="star2" _val="2"></a> <a href="javascript:;"
																		class="star3" _val="3"></a> <a href="javascript:;"
																		class="star4" _val="4"></a> <a href="javascript:;"
																		class="star5" _val="5"></a>
																	</span> <input type="hidden" name="commentStar">
																		<div class="clr"></div>
																</div>
															...
															<div class="item imgEl"
																...
																<div class="fl">
																	<div class="upload-img-box">
																		<div class="img-list">
																			<input type="hidden" name="imgs1" value=""> <input
																				type="hidden" name="imgs2" value=""> <input
																					type="hidden" name="imgs3" value=""> <input
																						type="hidden" name="imgs4" value=""> <input
																							type="hidden" name="imgs5" value=""> <input
																								type="hidden" name="imgs6" value=""> <input
																									type="hidden" name="imgs7" value=""> <input
																										type="hidden" name="imgs8" value=""> <input
																											type="hidden" name="imgs9" value="">
															...
															<div class="isL item">
																...
																<div class="fl">
																	<input id="seccode" acid="ZGgxODk8439" maxlength="7"
																		...
																		class="text text02 itxt" name=""> <img
																		class="seccodeimg" height="28" alt=""
																		src="/images/yzm.jpg"> <a href="#none"
																			class="seccodenext">(换一张)</a>
																</div>
																<div class="clr"></div>
															</div>
															...
															<div class="item item02">
																...
																<div class="fl">
																	<a href="#none" class="btn btn-5 mr20"> <s></s> <span
							...
							<dd class="fore2">
								<div class="item" id="_MYJD_credit">
									<a clstag="homepage|keycount|home2013|hbt" tag="213"
										href="http://baitiao.jd.com/creditUser/record">心情杂货铺白条</a>&nbsp;
								</div>
							</dd>
							<dd class="fore3">
								<div class="item" id="_MYJD_tx">
									<a target="_blank" clstag="homepage|keycount|home2013|htx"
										href="http://mobile.jd.com/yyswt/myjd.do">心情杂货铺通信</a>
								</div>
							</dd>
							<dd class="fore4">
							...
							<dd class="fore6">
								<div class="item" id="_MYJD_card">
									<a target="_blank" clstag="homepage|keycount|home2013|he"
										href="http://giftcard.jd.com/giftcard/index.action">心情杂货铺卡/E卡</a>
								</div>
							</dd>
							<dd class="fore7 last">

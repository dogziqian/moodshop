...
var category = {OBJ: $("#_JD_ALLSORT"),
		//URL_Serv: "http://rest.moodshop.com/rest/item/cat/list?callback=category.getDataService",
		//URL_Serv: "http://localhost:8082/category.json",
		//URL_Serv: "http://localhost:8081/category.json?callback=category.getDataService",
		URL_Serv: "http://rest.moodshop.xyz/rest/item/cat/list?callback=category.getDataService",

 ...
 */
function login() {
    return location.href = "http://sso.moodshop.xyz/page/login";
}
function regist() {
    return location.href = "http://sso.moodshop.xyz/page/register";
}
...
function search(a) {
    var b = "http://www.moodshop.xyz/search.html?q=" + encodeURIComponent(document.getElementById(a).value);

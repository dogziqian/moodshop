...
<div class="w w1 header clearfix">
	<div id="logo"><a href="/"><img clstag="clickcart|keycount|xincart|logo" src="/images/moodshop-logo.png" title="返回心情杂货铺首页" alt="返回心情杂货铺首页"></a></div>
...
<div class="cart-inner">
    <div class="cart-thead clearfix">
       <!--   <div class="column t-checkbox form"><input data-cart="toggle-cb" name="toggle-checkboxes" id="toggle-checkboxes_up" type="checkbox" checked="" value=""><label for="toggle-checkboxes_up">全选</label></div>-->
        ...
        <div class="column t-price">心情杂货铺价</div>
    ...
    <div id="product-list" class="cart-tbody">
        ...
        <c:forEach items="${cartList}" var="cart">
          ...
          <div class="cart-toolbar clearfix">
            ...
            <div class="amout fr"><span id="selectedCount">${cart.num}</span> 件商品</div>
        </div>
          ...
          <div class="control fdibu fdibucurrent">
             <!--  <span class="column t-checkbox form">
              ...
              <span class="shopping">
                  ...
                  <a href="www.moodshop.xyz" target="_blank" clstag="clickcart|keycount|xincart|coudanlink" id="continue">继续购物</a>
              </span>
          </div>
              ...
              <div class="cart-button">
                  ...
                  <span class="combine-btns" style="display:none">
                      ...
                      <span class="fore2 hide" style="display: inline;">
                          <a href="javascript:goToOverseaOrder();" class="checkout-jdInt">去心情杂货铺国际结算<b></b></a>
                          <a href="javascript:goToOrder();" class="checkout-jd">去心情杂货铺结算<b></b></a>
                      </span>
                  </span>
              </div>
              <div class="total fr">

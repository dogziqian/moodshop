...
<html>
	<head>
		...
		<link href="${ctx}/moodstore/AmazeUI-2.4.2/assets/css/amazeui.css" rel="stylesheet" type="text/css" />
		<link href="${ctx}/moodstore/AmazeUI-2.4.2/assets/css/admin.css" rel="stylesheet" type="text/css" />

		<link href="${ctx}/moodstore/basic/css/demo.css" rel="stylesheet" type="text/css" />

		<link href="${ctx}/moodstore/css/hmstyle.css" rel="stylesheet" type="text/css" />
		<script src="${ctx}/moodstore/AmazeUI-2.4.2/assets/js/jquery.min.js"></script>
		<script src="${ctx}/moodstore/AmazeUI-2.4.2/assets/js/amazeui.min.js"></script>
	...
	<body>
		<div class="hmtop">
			...
			<div class="am-container header">
				...
				<div class="nav white">
					<div class="logo"><img src="${ctx}/moodstore/images/logo.png" /></div>
					<div class="logoBig">
						<li><img src="${ctx}/moodstore/images/logobig.png" /></li>
					</div>
			...
			<div class="shopNav">
			    ...
			    <div class="bannerTwo">
                      <!--轮播 -->
						<div class="am-slider am-slider-default scoll" data-am-flexslider id="demo-slider-0">
							<ul class="am-slides">
								<li class="banner1"><a href="introduction.html"><img src="${ctx}/moodstore/images/ad5.jpg" /></a></li>
								<li class="banner2"><a><img src="${ctx}/moodstore/images/ad6.jpg" /></a></li>
								<li class="banner3"><a><img src="${ctx}/moodstore/images/ad7.jpg" /></a></li>
								<li class="banner4"><a><img src="${ctx}/moodstore/images/ad8.jpg" /></a></li>
							</ul>
						</div>
						<div class="clear"></div>	
			    </div>
										...
										<ul class="category-list navTwo" id="js_climit_li">
											<li>
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="${ctx}/moodstore/images/cake.png"></i><a class="ml-22" title="点心">点心/蛋糕</a></h3>
													<em>&gt;</em></div>
											...
											<li >
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="${ctx}/moodstore/images/cookies.png"></i><a class="ml-22" title="饼干、膨化">饼干/膨化</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
											...
											<li >
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="${ctx}/moodstore/images/meat.png"></i><a class="ml-22" title="熟食、肉类">熟食/肉类</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
											...
											<li >
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="${ctx}/moodstore/images/bamboo.png"></i><a class="ml-22" title="素食、卤味">素食/卤味</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
											...
											<li >
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="${ctx}/moodstore/images/nut.png"></i><a class="ml-22" title="坚果、炒货">坚果/炒货</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
											...
											<li >
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="${ctx}/moodstore/images/candy.png"></i><a class="ml-22" title="糖果、蜜饯">糖果/蜜饯</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
											...
											<li >
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="${ctx}/moodstore/images/chocolate.png"></i><a class="ml-22" title="巧克力">巧克力</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
											...
											<li >
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="${ctx}/moodstore/images/fish.png"></i><a class="ml-22" title="海味、河鲜">海味/河鲜</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
											...
											<li >
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="${ctx}/moodstore/images/tea.png"></i><a class="ml-22" title="花茶、果茶">花茶/果茶</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
											...
											<li>
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="${ctx}/moodstore/images/package.png"></i><a class="ml-22" title="品牌、礼包">品牌/礼包</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
					...
					<div class="am-g am-g-fixed smallnav">
						<div class="am-u-sm-3">
							<a href="sort.html"><img src="${ctx}/moodstore/images/navsmall.jpg" />
								<div class="title">商品分类</div>
							</a>
						</div>
						<div class="am-u-sm-3">
							<a href="#"><img src="${ctx}/moodstore/images/huismall.jpg" />
								<div class="title">大聚惠</div>
							</a>
						</div>
						<div class="am-u-sm-3">
							<a href="#"><img src="${ctx}/moodstore/images/mansmall.jpg" />
								<div class="title">个人中心</div>
							</a>
						</div>
						<div class="am-u-sm-3">
							<a href="#"><img src="${ctx}/moodstore/images/moneysmall.jpg" />
				...
				<!--各类活动-->
				<div class="row">
					<li><a><img src="${ctx}/moodstore/images/row1.jpg"/></a></li>
					<li><a><img src="${ctx}/moodstore/images/row2.jpg"/></a></li>
					<li><a><img src="${ctx}/moodstore/images/row3.jpg"/></a></li>
					<li><a><img src="${ctx}/moodstore/images/row4.jpg"/></a></li>
				</div>
				<div class="clear"></div>	
					<!--走马灯 -->
						...
						<div class="demo">
							...
							<ul>
								<li class="title-first"><a target="_blank" href="#">
									<img src="${ctx}/moodstore/images/TJ2.jpg"></img>
									<span>[特惠]</span>洋河年末大促，低至两件五折							
								</a></li>
								<li class="title-first"><a target="_blank" href="#">
									<span>[公告]</span>商城与广州市签署战略合作协议
								     <img src="${ctx}/moodstore/images/TJ.jpg"></img>
                     ...
                     <div class="sale-mt">
					  ...
					  <div class="am-g am-g-fixed sale">
						<div class="am-u-sm-3 sale-item">
							<div class="s-img">
								<a href="# "><img src="${ctx}/moodstore/images/sale3.jpg" /></a>
							</div>
                           <div class="s-info">
						...
						<div class="am-u-sm-3 sale-item">
							<div class="s-img">
								<a href="# "><img src="${ctx}/moodstore/images/sale2.jpg" /></a>
							</div>
                           <div class="s-info">
                           	   <a href="#"><p class="s-title">ZEK 原味海苔</p></a>
                           	   <div class="s-price">￥<b>9.90</b>
						...
						<div class="am-u-sm-3 sale-item">
							<div class="s-img">
								<a href="# "><img src="${ctx}/moodstore/images/sale1.jpg" /></a>
							</div>
                           <div class="s-info">
                           	   <a href="#"><p class="s-title">ZEK 原味海苔</p></a>
                           	   <div class="s-price">￥<b>9.90</b>
            ...
            <div class="f1">
					...
					<div class="am-g am-g-fixed floodSix ">				
						<div class="am-u-sm-5 am-u-md-3 text-one list">
							...
							<a href="# ">
								<img src="${ctx}/moodstore/images/5.jpg" />
								<div class="outer-con ">
									<div class="title ">
										零食大礼包开抢啦
									</div>
						...
						<div class="am-u-sm-7 am-u-md-5 am-u-lg-2 text-two big">
								...
								<a href="# "><img src="${ctx}/moodstore/images/act1.png" /></a>						
						</div>
						...
						<div class="am-u-md-2 am-u-lg-2 text-three">
							...
							<a href="# "><img src="${ctx}/moodstore/images/1.jpg " /></a>
						</div>
						</li>
						<li>
						<div class="am-u-md-2 am-u-lg-2 text-three sug">
							...
							<a href="# "><img src="${ctx}/moodstore/images/2.jpg " /></a>
						</div>
						</li>
						<li>
						<div class="am-u-sm-4 am-u-md-5 am-u-lg-4 text-five">
							...
							<a href="# "><img src="${ctx}/moodstore/images/5.jpg" /></a>
						</div>	
						</li>
						<li>
						<div class="am-u-sm-4 am-u-md-2 am-u-lg-2 text-six">
							...
							<a href="# "><img src="${ctx}/moodstore/images/3.jpg" /></a>
						</div>	
						</li>
						<li>
						<div class="am-u-sm-4 am-u-md-2 am-u-lg-4 text-six">
							...
							<a href="# "><img src="${ctx}/moodstore/images/4.jpg" /></a>
						</div>	
						</li>						
					</div>
					...
					<div class="am-g am-g-fixed floodSeven">
						<div class="am-u-sm-5 am-u-md-4 text-one list ">
							...
							<a href="# ">
								<div class="outer-con ">
                                  ...
                                  <img src="${ctx}/moodstore/images/11.jpg" />								
							</a>
							<div class="triangle-topright"></div>						
						</div>
							...
							<div class="am-u-sm-7 am-u-md-4 text-two big">
								...
								<a href="# "><img src="${ctx}/moodstore/images/act2.png " /></a>
                        ...
                        <li>
							<div class="am-u-sm-7 am-u-md-4 text-two">
								...
								<a href="# "><img src="${ctx}/moodstore/images/6.jpg" /></a>
							</div>
                        </li>
                        <li>
						<div class="am-u-sm-3 am-u-md-2 text-three sug">
							...
							<a href="# "><img src="${ctx}/moodstore/images/7.jpg" /></a>
						</div>
                        </li>
                        <li>
						<div class="am-u-sm-3 am-u-md-2 text-three big">
							...
							<a href="# "><img src="${ctx}/moodstore/images/10.jpg" /></a>
						</div>
                        </li>
                        <li>
						<div class="am-u-sm-3 am-u-md-2 text-three ">
							...
							<a href="# "><img src="${ctx}/moodstore/images/8.jpg" /></a>
						</div>
                        </li>
                        <li>
						<div class="am-u-sm-3 am-u-md-2 text-three ">
							...
							<a href="# "><img src="${ctx}/moodstore/images/9.jpg" /></a>
						</div>
						</li>
					</div>
                 <div class="clear "></div>                 
		...
		<div class="navCir">
			...
			<li><a href="${ctx}/moodstore/person/index.html"><i class="am-icon-user"></i>我的</a></li>					
		</div>
		<!--菜单 -->
		<div class=tip>
			<div id="sidebar">
				<div id="wrap">
					<div id="prof" class="item ">
						...
						<div class="ibar_login_box status_login ">
							<div class="avatar_box ">
								<p class="avatar_imgbox "><img src="${ctx}/moodstore/images/no-img_mid_.jpg " /></p>
								<ul class="user_info ">
									<li>用户名：sl1903</li>
									<li>级&nbsp;别：普通会员</li>
								</ul>
					...
					<div id="brand " class="item ">
						<a href="#">
							<span class="wdsc "><img src="${ctx}/moodstore/images/wdsc.png " /></span>
						</a>
						<div class="mp_tooltip ">
							我的收藏
							<i class="icon_arrow_right_black "></i>
					...
					<div id="broadcast " class="item ">
						<a href="# ">
							<span class="chongzhi "><img src="${ctx}/moodstore/images/chongzhi.png " /></span>
						</a>
						<div class="mp_tooltip ">
							我要充值
							<i class="icon_arrow_right_black "></i>
					...
					<div class="quick_toggle ">
						...
						<li class="qtitem ">
							...
							<div class="mp_qrcode " style="display:none; "><img src="${ctx}/moodstore/images/weixin_code_145.png " /><i class="icon_arrow_white "></i></div>
						</li>
						<li class="qtitem ">
		...
		<script type="text/javascript " src="${ctx}/moodstore/basic/js/quick_links.js "></script>
	</body>
</html>
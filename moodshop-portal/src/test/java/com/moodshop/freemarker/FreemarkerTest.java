package com.moodshop.freemarker;
...
//		第四步：告诉config对象模板文件存放的路径。
		configuration.setDirectoryForTemplateLoading(new File("F:\\bishe_workspace\\moodshop-portal\\src\\main\\webapp\\WEB-INF\\ftl"));
...
//		第八步：创建一个Writer对象，指定生成的文件保存的路径及文件名。
		Writer writer=new FileWriter("F:\\moodshop\\html\\hello.html");

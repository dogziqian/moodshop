...
<div class="w" id="logo">
    <div>
    	<a href="http://www.moodshop.xyz">
    		<img src="/images/moodshop-logo.png" alt="心情杂货铺" width="170" height="60"/>
    	</a> <b></b>
    </div>
</div>
            ...
            <div class="form" onselectstart="return false;">
					...
					<div class="item" id="dphone">
						...
						<div class="fl item-ifo">
							<input type="text" id="phone" maxlength="11" name="phone"
								...
								autocomplete="off" onkeyup="value=value.replace(/[^\d]/g,'')"/> <i class="i-phone"></i> <label
                ...
                <div class="item item-new">
                    ...
                    <div class="fl item-ifo">
                        ...
                        <label for="protocol">我已阅读并同意<a href="#" class="blue" id="protocol">《心情杂货铺用户注册协议》</a></label>
                        <span class="clr"></span>
...
<script type="text/javascript">
	var REGISTER={
		...
		inputcheck:function(){
				...
				if($("#pwd").val().length<6||$("#pwd").val().length>8){
					alert("请输入6-8位密码");
